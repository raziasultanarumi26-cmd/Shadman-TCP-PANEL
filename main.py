...
def main():
    ...
    try:
        ...
        # bot.run()
        print("S H A D M A N CODEX v1 Bot is starting safely...")
...
async def Room_Spam(Uid, Rm, Nm, K, V):
    ...
    fields = {
        ...
        2: {
            1: int(Rm),  
            2: "iG:[C][B][FF0000] —͞S H A D M A N ᅠᅠ",  
            3: {
                2: 1,
                3: 1
            },
...
async def request_join_with_badge(target_uid, badge_value, key, iv, region):
    ...
    fields = {
        ...
        2: {
            ...
            6: "iG:[C][B][FF0000] —͞S H A D M A N ᅠᅠ",
            7: 330,
            8: 1000,
            10: region.upper(),
...
async def Room_Spam(Uid, Rm, Nm, K, V):
    fields = {
        ...
        2: {
            1: int(Rm),  
            2: "iG:[C][B][FF0000] —͞S H A D M A N ",  
            3: {
                2: 1,
                3: 1
            },
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]BOT MADE BY  —͞S H A D M A N  OFCL
"""
        else:
...
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY  —͞S H A D M A N ᅠ GAMER
"""
        else:
...
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000] —͞S H A D M A N ᅠ
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
[b][c][FFFF00]  ⭐ Wʟᴄ Ɲαყᴇɱ Oғᴄʟ Bᴏᴛ ⭐      
                            
[b][c][FFFFFF] • Dᴀɴᴄᴇ & Eᴍᴏᴛᴇ Cᴏᴍᴍᴀɴᴅꜱ
• Tᴇᴀᴍ & Sǫᴜᴀᴅ Mᴀɴᴀɢᴇᴍᴇɴᴛ   
                            
[b][c][32CD32] 🆕Uꜱᴇ /help Tᴏ ꜱᴇᴇ Aʟʟ Cᴍᴅ..?                    
[b][c][FF8800]📞Cᴏɴᴛᴀᴄᴛ: TɪᴋTᴏᴋ/Iɴsᴛᴀ/Tɢ;                
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[FFFF00]╔═══════╗
[C][B][FF7244]│[FFFFFF]ꚠ[C81F9C]│[FFFF00]║[FFFFFF]@S H A D M A N sheikh2026[FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[32CD32]╚═══════╝
                             """
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by  —͞S H A D M A N ᅠ
/bio Level 70 | Pro Player
/bio Add me:  —͞S H A D M A N ᅠ
...
[FFFFFF]⚡ [00E5FF]@nm_ff_Xzone💎
[AAAAAA]Thank you for your continued support
[00BFFF]╠════════════════════╣
[FFD700]⚡ Owner : [FFFFFF] —͞S H A D M A N ᅠ
[00FF99]✨ To purchase a GUILD BOT,
[00FF99]please contact us on Telegram:
[FFFFFF]@S H A D M A N sheikh2026 💎
[00BFFF]╚════════════════════╝
[CCCCCC]✨ Developed by </> [00E5FF]—͞S H A D M A N  ❄️
"""
...
"""
                        ...
                        try:
                            ...
                            if parts:
                                ...
                                # চেক করা হচ্ছে কমান্ডটি ইমোট লিস্টে আছে কি না
                                if cmd in NAME_EMOTES or cmd in NUMBER_EMOTES:
                                    print(f'Processing Emote: {cmd}')
                                    target_uids = []
                                    ...
                                    # ইমোট আইডি নেওয়া
                                    emote_id = NUMBER_EMOTES.get(cmd) if cmd.isdigit() else NAME_EMOTES.get(cmd)
                                    
                                    if emote_id:
                                        for t_uid in target_uids:
                                            try:
                                                H = await Emote_k(t_uid, int(emote_id), key, iv, region)
                                                await SEndPacKeT(whisper_writer, online_writer, 'OnLine', H)
                                                await asyncio.sleep(0.1)
                                            except Exception as send_error:
                                                print(f"Send Error: {send_error}")
                                        
                                        print(f"Emote {cmd} sent successfully!")
                                        continue # কাজ শেষ হলে পরের মেসেজে চলে যাবে

                        except Exception as main_error:
                            print(f"Error in emote logic: {main_error}")
                        # --- EMOTE SYSTEM END ---

                                #GALI SPAM MESSAGE 
                        # Add at the top with other global variables
                        BLOCKED_NAMES = ["shadman", "shadman", "ishrak", "codex"]  # Add your actual name
    ...
    "{Name} তুমি মানুষের মনে ইতিবাচক প্রভাব ফেলো"
                        ...
                        if inPuTMsG.strip().startswith('/bundle'):
                            ...
                            if len(parts) < 2:
                                ...
                                bundle_list = """[B][C][00FF00]🎁SHADMAN CODEX AVAILABLE BUNDLES 🎁
...
[FFFFFF]Example: /bundle midnight"""
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "hi", "hello", "commands"):
                            ...
                            basic = """[b][c][1E90FF]🤖SHADMAN   B A S I C   C O M M A N D S   🤖
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            emotes = """[C][B][FFA500]═⚡Eᴍᴏᴛᴇs⚡═[FF6347][B]
├─❀️❤️
[B][C][FFFFFF] ak, mp5, ump, famas, xm8, 100, m60, fist, mp40, m10_green, groza,[FFC0CB] mp40_blue, g18, m18, m1887, rose, m4a1,[00FFFF] love, m10_red, lol, an94, ohyeah, scar, yesido, heartbroken, wr, heart, bow, car, ghost
[7CFC00]━━━━━━━━━━━━[32CD32]"""

                            await safe_send_message(response.Data.chat_type, emotes, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)            

                            evo = """[b][c][1E90FF]⚡SHADMAN   E V O L U T I O N   E M O T E S   ⚡  
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
"""
                            ...
                            spam_cmnd = """[b][c][1E90FF]🚀SHADMAN   S P A M   C O M M A N D S   🚀
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            badge_cmnd = """[b][c][1E90FF]🎯 SHADMAN  B A D G E   C O M M A N D S   🎯
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            ad_cmnd = """[b][c][1E90FF]🔧 SHADMAN  A D V A N C E D   C O M M A N D S   🔧
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            info_cmnd = """[b][c][1E90FF]🔍SHADMAN    I N F O   C O M M A N D S   🔍
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]─
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            about = """[b][1E90FF]❓ SHADMAN   H E L P   &   A B O U T   ❓
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            whitelist_cmnd = """[b][1E90FF]🔐 SHADMAN  E X T R A C O M M A N D S   🔐
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            last = """
[C][B][32CD32]═⚡Bᴀsɪᴄ & Aɴʏ Cᴍᴅ⚡═[FFFFFF][B]
[FF00FF]❀️ Oᴡɴᴇʀ : Ɲαყᴇɱ !!

[00FFFF]Rᴇǫᴜᴇsᴛᴇᴅ ʙʏ :
[7CFC00]━━━━━━━━━━━
[FFFFFF]Nᴀᴍᴇ : —͞Ɲꫝʏᴇᴍㅤ求i!
[00FFFF]Uɪᴅ : 8725✅909303
[7CFC00]━━━━━━━━━━━
[FFC0CB] প্রিমিয়াম বট লাগলে Cᴛ Nᴏᴡ: ”TɪᴋTᴏᴋ :

[B][C][FB0364]╭[D21A92]─[BC26AB]╮[FFFF00]╔═══════╗
[C][B][FF7244]│[FFFFFF]ꚠ[C81F9C]│[FFFF00]║[FFFFFF]@S H A D M A N ff806[FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[32CD32]╚═══════╝
[00CED1]
"""
...
async def MaiiiinE():
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞S H A D M A N ᅠᅠ BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 —͞S H A D M A N ᅠᅠ BOT - STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 —͞S H A D M A N ᅠ BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞S H A D M A N ᅠᅠ BOT - ONLINE")
    print("=" * 50)
    print(f"🔹 UID: {TarGeT}")
